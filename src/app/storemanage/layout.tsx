import AdminNavbarJS from "@/components/adminComponents/AdminNavbarJS";
import { getServerSession } from "next-auth";
import "react-quill/dist/quill.snow.css";
import { ToastContainer } from "react-toastify";
import { options } from "../api/auth/[...nextauth]/options";
import { redirect } from "next/navigation";
import { adminRole } from "./login/roles.enum";
import { headers } from "next/headers";
import { signOut } from "next-auth/react";
import SignOutBtn from "@/components/adminComponents/SignOutBtn";
export default async function RootLayout({
  ...
  if (
    (!session || session.user?.value.ROLE != adminRole) &&
    pathname != "/storemanage/login"
  ) {
    return redirect("/storemanage/login");
  }
  return (
    <div>
      {/* ts for Navbar */}
